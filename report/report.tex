...
Entre as 4 situações, nota-se claramente uma disparidade enorme nos resultados da query 8 para a situação 1 e 3.
Ou seja, comparando \color{blue}\textbf{HashMap}\textbf{black} com \color{blue}\textbf{TreeMap}\color{black} é evindente que o 1.º apresenta um comportamento muito mais eficiente nas necessidades da query 8.
De facto, as outras situações e queries não divergem substantivamente.

Demonstra-se assim que se deveria ter implementado um HashMap na estrutura de \color{blue}\textbf{Sales}\color{black}.
\section{Conclusão}
