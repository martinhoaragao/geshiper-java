...
Este relatório aborda a resolução do projeto prático em Java de LI3. O Projeto, denominado Gesthiper, baseia-se
...
Cada uma destas listas deve estar num ficheiro .txt e para cada um dos ficheiros o
